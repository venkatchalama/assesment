...
export declare class Letter {
    ...
    set template_id(newValue: string);
    /**
     * Unique identifier prefixed with `vrsn_`.
     * @type {string}
     * @memberof Letter
     */
    private "_template_version_id"?;
    get template_version_id(): string;
    set template_version_id(newValue: string);
    /**
 ...
 * @enum {string}
 */
export declare enum LetterCarrierEnum {
    Usps = "USPS"
}
/**
 * @export
 * @enum {string}
 */
export declare enum LetterObjectEnum {
    Letter = "letter"
}
/**
 * @export
 * @enum {string}
 */
export declare enum LetterAddressPlacementEnum {
